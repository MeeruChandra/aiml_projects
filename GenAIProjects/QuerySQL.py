...
#from prompt import MSSQL_AGENT_PREFIX, MSSQL_AGENT_FORMAT_INSTRUCTIONS


# SQL Server connection details

#from langchain_community.tools.sql_database.toolkit import SQLDatabaseToolkit
...
db_host = "localhost"  # e.g., "localhost" or "your_server_name"
...
connection_string = f"mssql+pyodbc://{username}:{password}@{server}/{database}?driver={driver.replace('{', '').replace('}', '')}"
